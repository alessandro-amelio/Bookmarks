...
b11 = Book.create(title: "A arte de Enganar", author: "Kevin Mitnick", description: "A hacker that talks about system invasions and social engineer.", publisher: "Elvisora", weeks_on_list: 12, rank_this_week: 11)
b12 = Book.create(title: "Mocking Bird", author: "Joe McQueen", description: "Are you? Are you? Come to the tree", publisher: "New Press Jersey", weeks_on_list: 188, rank_this_week: 12)
...
Review.create(comment: "Amazing", author: "Linda Liukas", book_id: b11.id)

Review.create(comment: "Super cool", author: "Cameron", book_id: b12.id)